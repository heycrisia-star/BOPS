...
const Footer: React.FC = () => {
  return (
    <footer className="px-6 py-24 text-center bg-white border-t border-slate-50 relative overflow-hidden">
      {/* Glow decorativo de fondo */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full max-w-lg h-64 bg-blue-50/50 rounded-full blur-[100px] -z-10"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <p className="text-[16px] md:text-[18px] text-slate-500 mb-12 max-w-[450px] mx-auto font-medium leading-relaxed">
          Escala tu operativa con sistemas que no fallan. Cuéntanos tu reto y nosotros diseñamos la infraestructura.
        </p>

        <div className="flex flex-col items-center gap-8">
          <button className="px-12 py-5 bg-slate-900 text-white rounded-2xl font-black text-[14px] uppercase tracking-widest hover:bg-blue-600 transition-all shadow-2xl hover:-translate-y-1 active:scale-95">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12 mt-4">
            ...
            >
              ...
              <span className="text-[18px] font-black text-slate-900 group-hover:text-blue-600 transition-colors tracking-tight">
                +34 691 708 138
              </span>
            </a>
        ...
        <div className="flex flex-col items-center pt-24 border-t border-slate-50 mt-16">
