    ...
    <section className="px-6 py-24 bg-[#020617] border-t border-slate-800">
      <div className="max-w-5xl mx-auto">
        <div className="mb-16 text-left">
          ...
          <h3 className="text-[36px] md:text-[54px] font-[900] text-white tracking-tight leading-[1.1] max-w-2xl">
          ...
          {steps.map((step, idx) => (
            <div key={idx} className="flex gap-8 group">
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 rounded-xl bg-slate-900 border border-slate-800 flex items-center justify-center shadow-sm group-hover:border-blue-500/50 group-hover:bg-slate-800 transition-all duration-500">
                  <span className="text-blue-500 font-black text-[16px] leading-none">{step.num}</span>
                </div>
              </div>
              <div className="pt-1">
                <h4 className="text-[20px] font-[800] text-white mb-3 tracking-tight">{step.title}</h4>
